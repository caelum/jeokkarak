...
Chokara is the korean version of hashis. In our case, chokara is used to support
evolution-ready schemas and loosely coupled systems in the web.

h2. Updated hash

Chokara only provides support for overriding values in a hash when you defined writer methods *do not* receive and interpret blocks (due to a famous ruby 1.8 limitation).
